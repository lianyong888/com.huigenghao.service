...
public class HttpclientUtil {
	 ...
	 * @throws NetServiceException 
	 */
	public static HttpResult getResult(String url, Map<String, String> params, String charset) throws NetServiceException {
		if (url == null || "".equals(url)) {
			return null;
		}
		List<NameValuePair> qparams = getParamsList(params);
		...
		try {
			...
			postResult.setResponse(responseStr);
			postResult.setHttpclient(httpclient);
			return postResult;
		} catch (ClientProtocolException e) {
			throw new NetServiceException("客户端连接协议错误", e);
		} catch (IOException e) {
	 ...
	 * @throws NetServiceException 
	 */
	public static HttpResult postResult(String url, Map<String, String> params, String charset) throws NetServiceException {
		if (url == null || "".equals(url)) {
			return null;
		}
		// 创建HttpClient实例
		...
		HttpResponse responseStr = null;
		try {
			responseStr = httpclient.execute(hp);
			postResult.setResponse(responseStr);
			postResult.setHttpclient(httpclient);
			return postResult;
		} catch (ClientProtocolException e) {
